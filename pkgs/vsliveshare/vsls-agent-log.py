...
try:
    ...
    XDG_RUNTIME_DIR = '/run/user/' + os.getuid()

DEV_LOG = '/dev/log'
SYSTEMD_JOURNAL_LOG = '/run/systemd/journal/dev-log'
VSLS_AGENT_LOG = XDG_RUNTIME_DIR + '/vsls-agent-log'
...
print("mounting path '{}' to '{}'...".format(DEV_LOG, VSLS_AGENT_LOG))
subprocess.call(['mount', '--bind', VSLS_AGENT_LOG, DEV_LOG])
